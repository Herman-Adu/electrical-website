          ...
          {items.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-6 rounded-xl border border-border bg-background/60 backdrop-blur-sm transition-all duration-300 hover:border-electric-cyan/40 hover:shadow-[0_0_30px_rgba(0,242,255,0.06)]"
              >
                {/* Top accent line */}
