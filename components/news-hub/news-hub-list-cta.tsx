...
export function NewsHubListCTA() {
  ...
  return (
    <div ref={containerRef} className="grid lg:grid-cols-2 gap-12">
      {/* Left — editorial copy + social links */}
      <motion.div
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
          Turn Knowledge{" "}
          <span className="text-electric-cyan">Into Action</span>
        </h3>

        <p className="text-muted-foreground mb-8 max-w-md">
          Our articles cover every aspect of electrical engineering — from
          compliance updates and installation breakthroughs to real-world case
          studies across London and the South East.
        </p>
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">
          Every article is backed by real project experience. When you&apos;re ready
          to put that knowledge into practice, our team is here to help.
        </p>
