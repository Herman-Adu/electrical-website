...
interface NewsArticleClosingCTAProps {
  categorySlug: string;
}

export function NewsArticleClosingCTA({
  categorySlug: _categorySlug,
}: NewsArticleClosingCTAProps) {
    ...
    <div ref={containerRef} className="grid lg:grid-cols-2 gap-12">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="font-mono text-xs tracking-widest uppercase text-electric-cyan">
            Follow Our Editorial
          </span>
        </div>

        <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
          Stay Informed on{" "}
          <span className="text-electric-cyan">Every Project</span>
        </h3>

        <p className="text-muted-foreground mb-8 max-w-md">
          Our editorial team covers compliance updates, installation
          breakthroughs, and real-world case studies from across London and the
          South East. Follow us for the latest.
        </p>
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">
          Ready to Start Your Project? Whether you need a compliance survey,
          full installation, or an EV charging solution — our team is ready to
          help.
        </p>
