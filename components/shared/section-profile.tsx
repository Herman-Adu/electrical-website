...
import { Linkedin, Twitter, Mail, Award, CheckCircle, ArrowRight, Facebook, Instagram, Youtube } from 'lucide-react';
        ...
        >
          ...
          <div className="w-full md:w-7/12">
            ...
            {quote && (
              ...
              >
                {/* Opening quote glyph */}
                <span className="absolute -top-4 left-6 text-5xl font-serif text-[var(--electric-cyan)]/40 leading-none select-none">
                  &ldquo;
                </span>
                <p className="text-foreground font-medium italic leading-relaxed text-lg">{quote}</p>
            ...
            {cta && (
              ...
              >
                <a
                  href={cta.href}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-sm border border-[var(--electric-cyan)] text-[var(--electric-cyan)] font-medium hover:bg-[var(--electric-cyan)] hover:text-background transition-all duration-300"
                >
                  {cta.label}
                  <ArrowRight size={16} />
                </a>
