    ...
    >
      ...
      <div className="section-content">
        ...
        {whyChoose && article && (
          <div className="grid lg:grid-cols-2 gap-16 mb-24 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="relative p-8 rounded-2xl border border-electric-cyan/30 bg-card/60 hover:border-electric-cyan/60 transition-all duration-300 group overflow-hidden">
                {/* Shimmer */}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href={article.href || "#"}
                    className="flex items-center gap-2 text-sm text-electric-cyan font-medium hover:gap-3 transition-all duration-200"
                  >
              ...
              {socials.links.map((social, idx) => {
                ...
                return (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-3 px-5 py-3 rounded-xl border border-border bg-card/40 hover:border-electric-cyan/40 hover:bg-electric-cyan/5 hover:shadow-lg hover:shadow-electric-cyan/10 transition-all duration-300 group"
                  >
                    <Icon
                      size={18}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative text-center py-20 px-8 rounded-3xl border border-electric-cyan/30 bg-electric-cyan/5 overflow-hidden"
        >
          {/* Blueprint grid inside CTA */}
          <div className="absolute inset-0 blueprint-grid opacity-20 pointer-events-none" />

          {/* Animated corner brackets */}
          <div className="absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-electric-cyan/50" />
          <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-electric-cyan/50" />
          <div className="absolute bottom-4 left-4 w-8 h-8 border-b-2 border-l-2 border-electric-cyan/50" />
          <div className="absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-electric-cyan/50" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {finalCTA.secondaryCTA && (
                <a
                  ...
                  className="px-10 py-5 border border-border text-foreground font-bold uppercase tracking-widest hover:border-electric-cyan hover:text-electric-cyan transition-all duration-300 text-sm rounded-sm"
                >
