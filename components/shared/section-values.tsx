...
export function SectionValues({ data }: SectionValuesProps) {
  const { sectionId, label, headline, headlineHighlight, description, values, tagline } = data;
          ...
          {values.map((value, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Short tagline */}
                <p className="font-mono text-xs tracking-wide text-muted-foreground/70 mb-4 italic">{value.short}</p>
