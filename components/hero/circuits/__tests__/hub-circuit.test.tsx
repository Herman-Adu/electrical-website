...
import { HubCircuit } from "../hub-circuit";
...
describe("HubCircuit", () => {
  describe("Rendering", () => {
    it("renders without crashing", () => {
      const { container } = render(<HubCircuit shouldReduceMotion={false} />);
  ...
  describe("shouldReduceMotion=true — no animation", () => {
    it("paths have duration 0 in transition when shouldReduceMotion=true", () => {
      const { container } = render(<HubCircuit shouldReduceMotion={true} />);
    ...
    it("scanline is not animated when shouldReduceMotion=true", () => {
      ...
      // scanline should either be absent or have data-animated="false"
