...
const certs = [
  ...
  {
    abbr: "Part P",
    name: "Building Regulations Competent Person",
    category: "Domestic Compliance",
    level: "Self-Certification Authorized",
    featured: false,
  },
  {
  ...
  {
    abbr: "ECS",
    name: "Electrotechnical Certification Scheme Gold Card",
    category: "Professional Competency",
    level: "Installation Electrician",
    featured: true,
  },
  {
    abbr: "SafeContractor",
    name: "Alcumus SafeContractor Accreditation",
    category: "Health & Safety Compliance",
    level: "Verified Supplier",
    featured: false,
  },
  {
    abbr: "18th Ed",
    name: "BS 7671:2018 Wiring Regulations",
    category: "Technical Standards",
    level: "City & Guilds 2382-22",
    featured: false,
  },
  {
    abbr: "Achilles Gold",
    name: "BuildingConfidence Gold CAS Accreditation",
    category: "Supply Chain & Compliance",
    level: "Certified (Audit Verified)",
    featured: true,
  },
  {
    abbr: "C&G 2391-52",
    name: "Initial and Periodic Inspection and Testing",
  ...
  {
    abbr: "IPAF",
    name: "Powered Access Licensed Registration (PAL)",
    category: "Height Safety",
    level: "Licensed (Category 3a/3b)",
    featured: false,
  },
];
