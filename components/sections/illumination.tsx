...
export function Illumination() {
  ...
  return (
    <section
      id="illumination"
      ref={containerRef}
      className="section-container relative min-h-svh lg:min-h-[90vh] flex flex-col justify-center"
      ...
      >
        <div className="section-content w-full">
          <div className="max-w-2xl">
            ...
            >
              From high-bay LED retrofits to complete industrial lighting
              systems, we deliver solutions that reduce energy costs by up to
              60% while maximizing visibility and safety across your facilities.
            </motion.p>
