        ...
        <svg className="w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="none">
          <defs>
            <pattern id="circuit" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
              <path
                d="M100,0 L100,50 L150,50 L150,150 L50,150 L50,100 L0,100"
                ...
                strokeDashoffset="0"
              />
              <circle cx="100" cy="50" r="3" fill="var(--electric-cyan)" opacity="0.6" />
              <circle cx="150" cy="150" r="3" fill="var(--electric-cyan)" opacity="0.6" />
            </pattern>
          </defs>
