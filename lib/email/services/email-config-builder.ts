...
export function getLogoHtml(config: ResolvedEmailConfig): string {
  ...
  return `<img src="${resolvedLogoUrl}" alt="${name}" style="height:56px;width:auto;max-width:200px;object-fit:contain;display:block;margin:0 auto;" />`;
}
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="email-header-text" style="vertical-align:middle;">
              ...
              <p style="margin:5px 0 0;color:${BRAND_COLORS.accentGreen};font-size:13px;line-height:1.4;">${config.company.tagline}</p>
            </td>
          </tr>
        </table>
      </td>
    </tr>
    <tr><td style="height:3px;background-color:${BRAND_COLORS.accentGreen};font-size:0;line-height:0;">&nbsp;</td></tr>`;
}
