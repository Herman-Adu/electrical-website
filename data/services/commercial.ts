    ...
    pillars: [
      {
        ...
        description:
          "Every installation fully compliant with UK electrical safety standards.",
      },
      {
        num: "02",
        title: "Minimal Disruption",
        description:
          "Strategic planning ensures your business operates smoothly during installation.",
      },
      {
        num: "03",
  ...
  sections: [
    {
      ...
      data: {
        ...
        quote:
          "The right electrical foundation sets your business up for decades of reliable operation.",
        credentials: [
          "High-Rise Wiring",
          "Consumer Units",
          "Distribution Boards",
    ...
    },
    {
      ...
      data: {
        ...
        quote:
          "Great lighting transforms spaces — and dramatically cuts your energy bills.",
        credentials: [
          "LED Upgrades",
          "Smart Controls",
          "Motion Sensors",
    ...
    },
    {
      ...
      data: {
        ...
        quote:
          "Your network infrastructure should accelerate your business, not hold it back.",
        credentials: [
          "Cat6A Cabling",
          "Fiber Optics",
          "Server Rooms",
        ...
        pillars: [
          {
            ...
            title: "EICR Reports",
            description:
              "Electrical Installation Condition Reports with detailed findings and actionable recommendations.",
            highlight: false,
          },
          {
            icon: "ClipboardCheck",
            title: "PAT Testing",
            description:
              "Portable Appliance Testing for all equipment — essential for insurance and health & safety compliance.",
            highlight: true,
          },
          {
            icon: "Shield",
            ...
            description:
              "Scheduled testing programs to maintain continuous compliance and prevent failures.",
            highlight: false,
          },
          {
            icon: "Award",
            ...
            description:
              "Complete certification packs for landlords, insurers, and regulatory bodies.",
            highlight: false,
          },
        ],
        checklist: [
        ...
        pillars: [
          {
            ...
            description:
              "Rapid response to electrical faults and emergencies — typically within 2 hours.",
            highlight: true,
          },
          {
            icon: "Wrench",
            ...
            description:
              "Scheduled inspections, testing, and preventive maintenance to avoid costly failures.",
            highlight: false,
          },
          {
            icon: "ClipboardCheck",
            ...
            description:
              "We track your certification dates and ensure you never fall out of compliance.",
            highlight: false,
          },
          {
            icon: "Clock",
            ...
            description:
              "Dedicated account management and priority scheduling for contract clients.",
            highlight: false,
          },
        ],
      },
