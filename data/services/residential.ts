...
export const residentialPageData: ServicePageData = {
  ...
  intro: {
    ...
    label: "Our Promise",
    headlineWords: ["Your", "Home", "Deserves", "Expert", "Care"],
    leadParagraph:
    ...
    pillars: [
      {
        ...
        description:
          "Fully qualified and registered for all domestic electrical work.",
      },
      {
        num: "02",
        title: "Clean & Tidy",
      ...
      },
      {
        ...
        title: "Fixed Pricing",
        description:
          "Transparent quotes with no hidden charges or surprise bills.",
      },
    ],
  },
  sections: [
    {
      ...
      data: {
        ...
        quote:
          "Your home deserves the same quality electrical work we'd put in our own.",
        credentials: [
          "Full Rewires",
          "Consumer Units",
          "New Builds",
    ...
    },
    {
      ...
      data: {
        ...
        quote:
          "The homes of tomorrow are being built today — make sure yours is ready.",
        credentials: [
          "EV Chargers",
          "Smart Lighting",
          "Home Automation",
        ...
        pillars: [
          {
            ...
            description:
              "Electrical Installation Condition Reports for homeowners, landlords, and property sales.",
            highlight: true,
          },
          {
            icon: "ClipboardCheck",
            ...
            description:
              "Legally required 5-year certificates for all rental properties. We handle the paperwork.",
            highlight: false,
          },
          {
            icon: "ClipboardCheck",
            title: "PAT Testing",
            description:
              "Portable appliance testing for landlords and home offices. Annual programs available.",
            highlight: false,
          },
          {
            icon: "Award",
            ...
            description:
              "Full building control notification and certification for all notifiable work.",
            highlight: false,
          },
        ],
        checklist: [
        ...
        pillars: [
          {
            ...
            description:
              "Power outages, tripping circuits, and electrical emergencies handled same-day.",
            highlight: false,
          },
          {
            icon: "Wrench",
            title: "Fault Finding",
            description:
              "Expert diagnosis of intermittent faults, humming sounds, and unexplained trips.",
            highlight: true,
          },
          {
            icon: "Lightbulb",
            ...
            description:
              "LED conversions, dimmer switches, and decorative lighting installations.",
            highlight: false,
          },
          {
            icon: "Plug",
            ...
            description:
              "New sockets, outdoor supplies, workshop circuits, and garden electrics.",
            highlight: false,
          },
        ],
      },
