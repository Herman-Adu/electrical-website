...
export const allNewsArticles: NewsArticle[] = [
  {
    ...
    detail: {
      ...
      toc: [
        ...
        { id: "body-context", label: "How LV Infrastructure Degrades", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "NICEIC approval means a contractor is approved to self-certify electrical work to BS 7671. To maintain that approval, contractors submit to annual site inspections where a visiting NICEIC engineer examines recently completed installations against the standard. Without NICEIC or ECA approval, a contractor cannot self-certify: every notifiable job must go to local building control, or the work is left uncertified — a Building Regulations offence.",
        "Professional indemnity insurance is where the compliance spectrum narrows most sharply. PI insurance covers losses arising from professional negligence in design or specification — an incorrectly sized circuit, an under-specified protection device, or a design decision that leads to system failure. Smaller contractors frequently carry public liability but not PI, leaving design liability either with the client or uninsured.",
      ],
      bodyContext: [
        "The NICEIC initial approval process requires a contractor to pass a technical competence assessment and have their installed work inspected by a visiting NICEIC engineer. It is not a form submission — it is a physical assessment of real completed work. Annual reassessment works the same way: the visiting engineer examines recently completed installations, and approval can be withdrawn if the quality of work does not meet the standard. This is what 'approved contractor' actually means, and why it is verifiable at niceic.com rather than something that can simply be claimed.",
        "The practical difference between PLI and PI matters most when something goes wrong in a design context. Public liability covers third-party bodily injury and property damage — a contractor dropping equipment on a client's server, for instance. PI covers the financial loss arising from a professional error: a circuit sized incorrectly that caused equipment failure, or a protection device specified at the wrong rating that led to an insurance claim. If a contractor carries PLI only and their design decision caused your loss, you may have no insured route to recover it.",
      ],
      specifications: [
        {
      ...
      toc: [
        ...
        { id: "body-context", label: "NICEIC Registration and Insurance Explained", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      toc: [
        ...
        { id: "body-context", label: "LV Capacity and Diversity Assessment", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "The starting point is your consumer unit. An EV charger draws a continuous 32A load — the equivalent of a large electric shower running for however many hours your vehicle charges. A modern consumer unit with a spare way is the ideal scenario, and the new circuit drops in cleanly. An older unit without spare capacity, or one that uses rewirable fuses rather than MCBs, will need upgrading before the charger can be installed.",
        "Smart charging is mandatory for all new residential EV chargepoints — any installer offering a non-smart unit is offering non-compliant equipment. The OZEV EVHS grant of up to £350 is applied by the installer on your behalf, but only OZEV-approved installers using OZEV-approved charger models can do this. Confirm both before you book.",
      ],
      bodyContext: [
        "Your home's earthing arrangement matters more for EV charging than for most domestic additions. TN-C-S (PME) is the most common UK domestic arrangement, but some properties — typically older homes in rural areas — are on a TT system where the earth is provided via an electrode at the property rather than a metallic return from the distributor. For PME supplies, there are specific considerations around voltage rise on the earthed conductor under fault conditions; for TT properties, the charger must have built-in protection appropriate to the earthing arrangement. Your installer should identify the earthing system at survey. If they don't mention it, ask.",
        "Each circuit on a modern consumer unit is typically protected by an RCBO — a combined MCB and RCD in a single device — which gives individual fault protection without tripping the whole board. Older boards may use a single RCD covering multiple circuits, meaning a fault on the EV circuit could trip other loads. If your consumer unit is more than 15–20 years old or lacks individual RCBO protection, the EV installation is a good moment to address the whole board. For landlords, the OZEV landlord scheme covers up to £350 per socket for up to 200 sockets per application — a separate route from the homeowner EVHS grant, and worth confirming eligibility before committing to an installation programme.",
      ],
      specifications: [
        {
      ...
      toc: [
        ...
        { id: "body-context", label: "Consumer Unit, Earthing, and Grant Eligibility", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "The IET Code of Practice classifies portable appliances into three equipment classes, and recommends retesting intervals based on both class and operating environment. Office and hotel environments warrant the longest intervals; commercial kitchens, construction sites, and warehouses warrant significantly shorter ones. These frequency recommendations are starting points for a written risk assessment — not fixed mandatory schedules.",
        "Commercial property insurance is where PAT compliance most directly affects financial exposure. Many policies contain electrical equipment maintenance conditions, and the IET Code of Practice is the standard against which maintenance is assessed. Whether your policy mandates annual testing, references the IET CoP, or defers to the duty holder's risk assessment should be confirmed in writing from your broker.",
      ],
      bodyContext: [
        "Class I equipment depends on an earth connection for protection — desktop computers, floor-standing printers, catering equipment, power tools. Because the earth path is load-bearing for safety, Class I requires both insulation resistance and earth continuity testing; a pass on one does not substitute for the other. Class II is double-insulated — most power supplies, portable tools, battery chargers — and requires insulation resistance testing only. Class III operates at safety extra-low voltage and presents the lowest electrical risk.",
        "The frequency difference between environments is significant. Class I equipment in a standard office might reasonably sit on a four-year initial retest cycle under the IET CoP risk matrix. The same class in a warehouse or commercial kitchen warrants annual or sub-annual testing. In construction and logistics environments, three-to-six month intervals are appropriate for Class I tools. The written risk assessment documents why each frequency band was selected — and that documented reasoning is what demonstrates to an insurer or enforcement body that the compliance decision was deliberate, not arbitrary.",
      ],
      specifications: [
        {
      ...
      toc: [
        ...
        { id: "body-context", label: "Equipment Classes and Insurance Risk", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "EICR and PAT are separate obligations addressing different parts of the same legal framework. An EICR covers the fixed installation — circuits, sockets, consumer unit — while PAT covers landlord-supplied portable appliances on the tenancy inventory: the washing machine, fridge, toaster, television. Neither substitutes for the other, and both are required.",
        "In HMO communal areas, all landlord-supplied equipment is in scope, and shared use by multiple occupants warrants shorter retest intervals. A written risk assessment documenting frequency decisions per category, backed by a full numeric test register rather than pass labels alone, is what satisfies licensing inspections, insurance conditions, and enforcement inquiries.",
      ],
      bodyContext: [
        "The specific regulations in scope are the Electrical Safety Standards in the Private Rented Sector (England) Regulations 2020 for EICR — which requires a five-year inspection cycle — and the Electricity at Work Regulations 1989 for PAT, with the IET Code of Practice 4th edition as the recognised method for demonstrating compliance. Using the IET CoP as the basis for a frequency schedule means the landlord can demonstrate that their compliance decision was reasoned and documented, not arbitrary.",
        "For HMO communal areas, the recommended intervals under the IET CoP risk matrix are typically annual or two-year cycles for kitchen and laundry appliances — reflecting higher-frequency use and the moisture environment — and two to four years for living area and bedroom equipment. The numeric test register required under this framework must identify each appliance individually, show insulation resistance and earth continuity readings where applicable, and record the next test date. That level of detail is what distinguishes a compliance programme from a visit that produced labels.",
      ],
      methodology: [
      ...
      toc: [
        ...
        { id: "body-context", label: "EICR, PAT Scope, and HMO Obligations", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "PUWER creates the legal duty to maintain all work equipment in safe condition. In industrial environments, Class I equipment — angle grinders, power drills, welding sets — relies on an earth connection and requires both insulation resistance and earth continuity testing. Industrial environments warrant significantly shorter retest intervals than office settings, reflecting continuous load, mechanical handling, and exposure to moisture.",
        "The 110V Centre-Tapped Earth (CTE) system is the UK standard risk-reduction measure for construction and many industrial sites, identified by orange connectors to BS EN 60309. CTE equipment must be tested at voltages appropriate to the system — not all PAT contractors carry the adapters or hold the procedural knowledge, and confirming CTE competence before commissioning is a prerequisite for valid test results.",
      ],
      bodyContext: [
        "The specific test requirements for Class I equipment are both insulation resistance and earth continuity — because the equipment's safety depends on the earth path being intact, a pass on insulation resistance alone is not sufficient. Class II double-insulated equipment (most hand tools and IT equipment) requires insulation resistance testing only and can operate on longer intervals in the same environments. Class III extra-low-voltage equipment presents the lowest risk and the least demanding test requirements.",
        "Manufacturing environments warrant six-to-twelve month intervals for Class I equipment under the IET CoP risk matrix. Construction sites — where tools face mechanical damage, moisture ingress, and multi-operative handling — warrant three-month intervals. Under RIDDOR 2013, any electrical incident causing hospitalisation triggers an HSE investigation that will examine the maintenance record for the equipment involved: the PAT register showing numeric test results, remedial actions, and next test dates is the documentary defence. A combined PUWER-plus-PAT programme under a single asset identifier is the most efficient and legally complete approach for industrial facilities.",
      ],
      methodology: [
      ...
      toc: [
        ...
        { id: "body-context", label: "PUWER Duties, Equipment Classes, and CTE Systems", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "Thames Valley Adventure Playground in Taplow is a registered charity providing a fully accessible outdoor adventure play environment for children and young people with disabilities and additional needs. Nexgen has delivered certified electrical infrastructure to the same standard as any commercial project — inspected, certified, and signed off to BS 7671. The difference is the client, the budget parameters, and the reason the work matters to the people who use the facility.",
        "Slough in Bloom is the local branch of the Britain in Bloom programme, run annually by the Royal Horticultural Society. Nexgen supported the 2023 entry as a sponsor. That entry won the gold award and was named overall winner in the Slough category — a result that reflects sustained community engagement, not a single push in the weeks before judging.",
      ],
      bodyContext: [
      ...
      toc: [
        ...
        { id: "body-context", label: "TVAP and Slough in Bloom in Detail", level: 2 as const },
  ...
  },
  {
    ...
    detail: {
      ...
      body: [
        "Britain in Bloom is the UK's largest horticultural campaign, run by the Royal Horticultural Society since 1964. The judging framework covers three areas: horticultural achievement, environmental responsibility, and community participation. Gold is not a display-day result — it requires sustained community engagement and environmental commitment that the judges can verify has been consistent throughout the year.",
        "The 2023 entry that Nexgen supported won the gold award in the Slough category and was named overall winner. An overall winner result reflects the judges' assessment that the entry was outstanding across all three judging criteria — not just the strongest display on the day.",
      ],
      bodyContext: [
        "Britain in Bloom is structured in regional and national tiers, with local entries feeding upward into regional competitions such as Thames and Chiltern. Preparation for a gold-level entry begins in the preceding autumn with planting schedules that run through winter and spring, with the main growing season requiring sustained maintenance leading up to the summer judging period.",
        "Nexgen's contribution was as a supporting sponsor — contributing to the resources required to develop and maintain the entry over a full year. The sponsorship supports materials, plant stock, and the sustained maintenance effort that a gold-level programme requires. A gold award entry is the product of that kind of resourced, year-round commitment — not a single push in the weeks before the judges arrive.",
      ],
      takeaways: [
      ...
      toc: [
        ...
        { id: "body-context", label: "Britain in Bloom Competition Structure", level: 2 as const },
