...
|------|-------|-----|-------|
| Primary accent | Deep cyan | #c2fff1 | Main elements, primary boxes, key concepts |
| Secondary accent | Rich amber | #fef3c7 | Supporting elements, secondary info, highlights |
| Success/output | Electric teal | #e0faf6 | Results, outputs, completed states, positive |
| Warning/attention | Amber/warm | #fef3c7 | Alerts, problems, pain points, "before" states |
| Tertiary accent | Deep forest | #b3f5e6 | Optional third category, connections, meta-info |
| Text | Near-black | #1e1e1e | All text and labels |
| Lines/arrows | Slate | #334155 | All connector lines, arrows, borders |
| Background | White | #ffffff | Always clean white, no texture |

### Color Assignment Rules

When building prompts, explicitly assign colors to elements:
- **Flows (left to right):** Cyan (input) -> Amber (process) -> Teal (output)
- **Comparisons (side by side):** Amber (old/bad/slow) vs Teal (new/good/fast)
- **Hub and spoke:** Cyan (center hub), mixed colors for spokes
- **Hierarchies (top to bottom):** Cyan (top level), Teal (middle), Deep (bottom)
- **Lists/grids:** Alternate colors row by row for visual rhythm

Never let the model choose colors. Always specify: "The [element] box is filled with deep cyan (#c2fff1)."
...
- 2-3px dark gray (#334155) stroke/outline
...
- Dark gray (#334155) stroke, 2px weight
