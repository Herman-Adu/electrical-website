...
description: Use when asked to diagram, draw, visualize, flowchart, or show how something works. Trigger phrases: architecture, flowchart, state machine, compare, data pipeline, timeline, visualize, hub and spoke, photo, headshot. Routes to Mermaid/Excalidraw/kie.ai/nano-banana automatically.
